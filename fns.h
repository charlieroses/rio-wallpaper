...
int	parsewctl(char**, Rectangle, Rectangle*, int*, int*, int*, int*, int*, int*, char**, char*, char*);
...
//wp.c
void	loadnewscale(int, int);
int	loadnewwallpaper(char*);
int	updatewallpaper(void);
void resizmple(Image*, int, int);
WPConfig *allocwpconfig(int, int);
void reallocimage(Image*, int, int, uchar*, int);
